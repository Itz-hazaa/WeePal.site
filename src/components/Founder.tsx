...
//                 <img
//                   src={founderImage}
//                   alt="Mohammed Hassaan Ali - Founder of WeePal"
...
//               {[
//                 "Homeschooled innovator who built TechShala (500+ students)",
//                 "Created robotics curriculum used in 5+ Hyderabad schools",
//                 "Conducted 30-day North India Robotics Tour ('25)",
//                 "Building WeePal to fix what's broken in K12 education",
//               ].map((item) => (
//                 <li
//                   key={item}
...
//             <ul className="space-y-3">
//               {[
//                 "Started teaching B.Tech/M.Tech engineers at age 11 (NDTV featured)",
//                 "Built TechShala reaching 500+ students with robotics education",
//                 "Developed voice-controlled humanoid robot & serving robot",
//                 "Created robotics curriculum adopted by 5+ Hyderabad schools",
//                 "Building WeePal to revolutionize K-12 education",
//               ].map((item) => (
//                 <li
//                   key={item}
//                   className="flex items-start gap-2 text-foreground/85"
...
const founders = [
  {
    ...
    role: "Founder",
    initials: "MH",
    bio: "Taught engineers at 11. Built TechShala serving 500+ students. Robotics visionary making tech education accessible across India.",
    links: [
      ...
      { icon: Instagram, href: "https://www.instagram.com/techshala.official", label: "@techshala" },
      { icon: Instagram, href: "https://www.instagram.com/littleweepal", label: "@weepal" },
    ],
  },
  {
    name: "Shaik Sahil",
  ...
  },
  {
    ...
    role: "Co‑founder",
    initials: "AR",
    bio: "Parent insights specialist. Designs programs parents trust. \"Let Your Child Be The Next Hassaan.\"",
    links: [],
  },
];
                ...
                <div className="flex items-center justify-center gap-2 flex-wrap pt-4 border-t border-border/50">
                  {f.links.map((l) => (
                    <a
                      ...
                      className="inline-flex items-center gap-1.5 text-xs font-medium text-muted-foreground hover:text-primary bg-accent rounded-full px-3 py-1.5 transition-colors"
                    >
